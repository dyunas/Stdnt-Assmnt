										...
										<table id="student_tbl" class="table table-striped table-bordered table-hover">
											...
											<?php if ($stud_info): ?>
												<?php foreach($stud_info as $info): ?>
													...
													<tr>
														<td style="text-align: center;"><?php echo $info->stud_id; ?></td>
														<td><?php echo $info->stud_name; ?></td>
														<td style="text-align: center;"><?php echo $info->stud_course; ?></td>
														<td style="text-align: center;"><?php echo $year[$info->stud_year].' Year'; ?></td>
