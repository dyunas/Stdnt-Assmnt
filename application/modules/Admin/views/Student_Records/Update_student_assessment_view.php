							  ...
							  <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
								  ...
								  <select class="form-control input-xxlarge" id="stud_course" name="stud_course">
								  	...
								  	<?php foreach($course as $item): ?>
								  		<option value="<?php echo $item->course_code; ?>" <?php echo ($stud_info->stud_course == $item->course_code) ? 'selected="selected"' : ''; ?>><?php echo $item->course_name; ?></option>
								  	<?php endforeach; ?>
								  </select>
									</div>
							  </div>
							  ...
							  <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
							  	<div class="clearfix">
									  <select class="form-control input-xxlarge" name="stud_year">
									  	...
									  	<option value="1" <?php echo ($stud_info->stud_year == '1') ? 'selected="selected"' : ''; ?>>1st Year</option>
									  	<option value="2" <?php echo ($stud_info->stud_year == '2') ? 'selected="selected"' : ''; ?>>2nd Year</option>
									  	<option value="3" <?php echo ($stud_info->stud_year == '3') ? 'selected="selected"' : ''; ?>>3rd Year</option>
									  	<option value="4" <?php echo ($stud_info->stud_year == '4') ? 'selected="selected"' : ''; ?>>4th Year</option>
									  </select>
									</div>
							  </div>
							</div><!-- form-group -->
