	...
	<?php elseif ($this->session->userdata('user_type') == 'Cashier'):?>
		<script type="text/javascript">
			try{ace.settings.check('main-container' , 'fixed')}catch(e){}
		</script>
		<div id="sidebar" class="sidebar responsive">
			...
			<ul class="nav nav-list">
				<li class="<?php echo (site_url($this->uri->segment(1).'/'.$this->uri->segment(2)) == site_url('cashier/dashboard')) ? 'active' : '' ; ?>">
					<a href="<?php echo site_url('cashier/dashboard'); ?>">
						<i class="menu-icon fa fa-home"></i>
						<span class="menu-text">Dashboard</span>
					</a>
					<b class="arrow"></b>
